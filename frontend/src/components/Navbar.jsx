...
import NotificationDropdown from './NotificationDropdown'; // Import the component we created
          ...
          {isLanding ? (
            ...
            <>
              ...
              <div 
                ...
                className="w-9 h-9 rounded-full bg-rgukt-maroon/10 border border-rgukt-maroon/20 flex items-center justify-center text-rgukt-maroon font-black cursor-pointer hover:bg-rgukt-maroon hover:text-white transition-all duration-200"
              >
                UD
              </div>
            </>
