    ...
    <div className="fixed bottom-8 left-0 right-0 flex justify-center z-50">
      ...
      <nav className="flex items-center gap-1.5 md:gap-2.5 bg-white/90 backdrop-blur-md px-6 py-2.5 rounded-full border border-slate-200 shadow-dock">
        ...
        <div className="relative px-2">
          ...
          <button className="bg-rgukt-maroon p-4 rounded-full -mt-12 border-4 border-rgukt-slate shadow-lg hover:scale-110 transition-transform cursor-pointer group">
